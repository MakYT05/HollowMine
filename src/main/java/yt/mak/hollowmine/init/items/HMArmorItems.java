...
public class MakArmorItems {
    public static final Holder<ArmorMaterial> HOLLOW_ARMOR_MATERIAL = register("hollow_arm", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
                attribute.put(ArmorItem.Type.CHESTPLATE, 9);
                attribute.put(ArmorItem.Type.HELMET, 5);
                attribute.put(ArmorItem.Type.BODY, 11);
            }), 15, 4f, 0.1f, () -> MakItems.HOLLOW.get());
