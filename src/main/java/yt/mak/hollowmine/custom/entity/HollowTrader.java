...
public class HollowTrader extends Animal {
    ...
    public HollowTrader(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return HMEntities.HOLLOW_TRADER.get().create(pLevel);
    }
