...
import yt.mak.hollowmine.client.anim.HollowGoodSunAnim;
import yt.mak.hollowmine.custom.entities.HollowGoodSun;

public class HollowGoodSunModel <T extends HollowGoodSun> extends HierarchicalModel<T> {
    ...
    public HollowGoodSunModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(HollowGoodSun entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);

        this.animateWalk(HollowGoodSunAnim.FLY, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, HollowGoodSunAnim.FLY, ageInTicks, 1f);
    }
