...
public class HollowKnightModel <T extends HollowKnight> extends HierarchicalModel<T>{
    ...
    @Override
    public void setupAnim(HollowKnight entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().getAllParts().forEach(ModelPart::resetPose);

        this.animateWalk(HollowKnightAnim.GO, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, HollowKnightAnim.GO, ageInTicks, 1f);
    }
